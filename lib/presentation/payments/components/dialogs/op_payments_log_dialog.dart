...
import 'package:lambda_dent_dash/presentation/payments/components/dialogs/op_payments_log_table.dart';
...
Dialog OpPaymentsLogDialog(BuildContext context) {
  ...
  return Dialog(
    child: BlocProvider(
      create: (_) => OperatingPaymentsCubit()..fetchOperatingPayments(),
      child: Padding(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              BlocConsumer<OperatingPaymentsCubit,
                                  OperatingPaymentsState>(
                                listener: (context, state) {},
                                builder: (context, state) {
                                  final isSubmitting =
                                      state is OperatingPaymentsSubmitting;
                                  return defaultButton(
                                      ...
                                      function: () {
                                        ...
                                        final confirm =
                                            confirmValueController.text.trim();
                                        if (name.isEmpty ||
                                            value.isEmpty ||
                                            confirm.isEmpty ||
                                            value != confirm) {
