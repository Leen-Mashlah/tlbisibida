class DBInvEmpProfileResponse {
  bool? status;
  int? successCode;
  LabManagerProfile? profile;
  String? successMessage;

  DBInvEmpProfileResponse(
      {this.status, this.successCode, this.profile, this.successMessage});

  DBInvEmpProfileResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class LabManagerProfile {
  int? id;
  int? labManagerId; // Note: Changed from dentist_id to lab_manager_id
  String? firstName;
  String? lastName;
  String? email;
  String? emailVerifiedAt;
  int? emailIsVerified;
  dynamic verificationCode; // Can be null
  int? isStaged;
  String? phone;
  // 'address' and 'attendence_time' are missing in this profile type
