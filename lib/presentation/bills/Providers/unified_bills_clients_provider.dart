...
enum BillsClientsPageType {
  bills,
  clientDetails,
}

class UnifiedBillsClientsProvider extends StatelessWidget {
  final BillsClientsPageType pageType;
  ...
  DBBillsRepo get billsRepo => locator<DBBillsRepo>();
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<BillsCubit>(
          create: (context) => BillsCubit(billsRepo),
        ),
  ...
  Widget _buildPage(BuildContext context) {
    switch (pageType) {
      case BillsClientsPageType.bills:
        return BillsPage();
      case BillsClientsPageType.clientDetails:
